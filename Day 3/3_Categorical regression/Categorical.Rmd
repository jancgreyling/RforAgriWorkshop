...
```{r}
plot(y=chap10data4[chap10data4$Died=="No",]$Birthweight,
     x=chap10data4[chap10data4$Died=="No",]$Apgar.score,col="blue",ylab="Weight",xlab="Apgar")
points(y=chap10data4[chap10data4$Died=="Yes",]$Birthweight,
     x=chap10data4[chap10data4$Died=="Yes",]$Apgar.score,col="red")

scatterplotMatrix(~Birthweight + Apgar.score + Temperature,data=chap10data4,
...
```{r}
chap10data4.model2 <- glm(Died ~ Delivery.mode+Birthweight+Apgar.score, family=binomial(), data=chap10data4)
